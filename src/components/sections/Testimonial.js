...
const Testimonial = ({
  ...
  const sectionHeader = {
    title: <EditableText fSize="44" text="Customer testimonials" />,
    paragraph: (
      <EditableText
        fSize="20"
          ...
          <div className={tilesClasses}>
              ...
              <div className="tiles-item-inner">
                ...
                <div className="testimonial-item-footer text-xs mt-32 mb-0 has-top-divider">
                  <span className="testimonial-item-name text-color-high">
                    <EditableText fSize="16" text="Roman Level" />
                  </span>
                  <span className="text-color-low"> / </span>
                  <span className="testimonial-item-link">
                    <a href="#0">
                      <EditableText fSize="16" text="AppName" />
                    </a>
                  </span>
                </div>
              </div>
            ...
            <div className="tiles-item " data-reveal-delay="200">
              <div className="tiles-item-inner">
                ...
                <div className="testimonial-item-footer text-xs mt-32 mb-0 has-top-divider">
                  <span className="testimonial-item-name text-color-high">
                    <EditableText fSize="16" text="Ben Stafford" />
                  </span>
                  <span className="text-color-low"> / </span>
                  <span className="testimonial-item-link">
                    <a href="#0">
