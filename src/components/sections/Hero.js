        ...
        <div className={innerClasses}>
          <div className="hero-content">
            <h1 className="mt-0 mb-16 " data-reveal-delay="200">
              <EditableText fSize="52" text="Landing template for" />{" "}
              <span className="text-color-primary">
                <EditableText fSize="52" text="startups" />
              </span>
            </h1>
              ...
              <div className="" data-reveal-delay="600">
                <ButtonGroup>
                  <Button tag="a" color="primary" wideMobile href="#">
                    <EditableText fSize="16" text="Get started" />
                  </Button>
                  <Button tag="a" color="dark" wideMobile href="#">
                    <EditableText fSize="16" text="View on Github" />
                  </Button>
                </ButtonGroup>
              </div>
            </div>
