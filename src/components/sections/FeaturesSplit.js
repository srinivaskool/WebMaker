...
const FeaturesSplit = ({
  ...
  const sectionHeader = {
    title: <EditableText fSize="44" text="Workflow that just works" />,
    paragraph: (
      <EditableText
        fSize="20"
            ...
            <div className="split-item">
              ...
              >
                <div className="text-xxs text-color-primary fw-600 tt-u mb-8">
                  <EditableText fSize="14" text="Lightning fast workflow" />
                </div>
                <h3 className="mt-0 mb-12">
                  <EditableText fSize="32" text="Data-driven insights" />
                </h3>
                <p className="m-0">
                  <EditableText
                    fSize="20"
